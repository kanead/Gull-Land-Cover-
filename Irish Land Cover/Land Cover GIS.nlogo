extensions[gis]
globals [ireland patch-scale day freshwater freshwater-nutrients other-nutrients]
breed [gulls gull]
...
;  set freshwater gis:load-dataset "WFD_Transitional_Waterbodies_ITM.shp"
  ...
  [ if gis:property-value ? "CODE_12" = "523" [ gis:set-drawing-color blue gis:fill ? 2.0] ;; sea and ocean
    if gis:property-value ? "CODE_12" = "522" [ gis:set-drawing-color sky  gis:fill ? 2.0] ;; estuaries
    if gis:property-value ? "CODE_12" = "521" [ gis:set-drawing-color sky  gis:fill ? 2.0] ;; coastal lagoons
    if gis:property-value ? "CODE_12" = "512" [ gis:set-drawing-color sky  gis:fill ? 2.0] ;; water bodies
    if gis:property-value ? "CODE_12" = "511" [ gis:set-drawing-color sky  gis:fill ? 2.0] ;; water courses
    if gis:property-value ? "CODE_12" = "423" [ gis:set-drawing-color sky  gis:fill ? 2.0] ;; intertidal flats
    if gis:property-value ? "CODE_12" = "421" [ gis:set-drawing-color sky  gis:fill ? 2.0] ;; salt marshes
    if gis:property-value ? "CODE_12" = "412" [ gis:set-drawing-color sky  gis:fill ? 2.0] ;; peat bogs
    if gis:property-value ? "CODE_12" = "411" [ gis:set-drawing-color sky  gis:fill ? 2.0] ;; inland marshes
...
to check-water
  let estuaries gis:find-one-feature ireland "CODE_12" "522"
   ask nutrients [
